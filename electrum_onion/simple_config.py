...
FEE_DEPTH_TARGETS = [1000000, 500000, 200000, 100000, 50000, 20000, 10000]
...
class SimpleConfig(Logger):
    ...
    def get_wallet_path(self, *, use_gui_last_wallet=False):
        ...
        old_path = os.path.join(self.path, "electrum-onion.dat")
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-onion.conf into user_config[]."""
    if not path:
        return {}
