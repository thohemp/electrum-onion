...
from electrum_onion import transaction, bitcoin
from electrum_onion.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
                                      PartialTransaction, TxOutpoint, PartialTxInput,
                                      PartialTxOutput)
from electrum_onion.util import bh2u, bfh
from electrum_onion.bitcoin import (deserialize_privkey, opcodes,
