...
from electrum_onion.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_onion.bitcoin import public_key_to_p2pkh
from electrum_onion.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_onion import ecc
from electrum_onion.ecc import msg_magic
from electrum_onion.wallet import Standard_Wallet
from electrum_onion import constants
from electrum_onion.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_onion.i18n import _
from electrum_onion.keystore import Hardware_KeyStore
from electrum_onion.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_onion.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_onion.network import Network
from electrum_onion.logging import get_logger
from electrum_onion.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("DeepOnion Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
