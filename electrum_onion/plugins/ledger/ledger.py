...
from electrum_onion import ecc, constants
from electrum_onion import bip32
from electrum_onion.crypto import hash_160
from electrum_onion.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
from electrum_onion.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
...
from electrum_onion.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_onion.base_wizard import ScriptTypeNotSupported
from electrum_onion.logging import get_logger
from electrum_onion.plugin import runs_in_hwd_thread, Device
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in DeepOnion mode")) from e
                raise e
