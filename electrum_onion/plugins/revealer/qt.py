...
from electrum_onion.util import make_dir, InvalidPassword, UserCancelled
from electrum_onion.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                      WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_onion.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_onion.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_onion.gui.qt.password_dialog import PasswordDialog
