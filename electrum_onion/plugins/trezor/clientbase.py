...
from electrum_onion.util import UserCancelled, UserFacingException
from electrum_onion.keystore import bip39_normalize_passphrase
from electrum_onion.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from electrum_onion.logging import Logger
from electrum_onion.plugin import runs_in_hwd_thread
from electrum_onion.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the DeepOnions in the wallet.").format(self.device)
        else:
