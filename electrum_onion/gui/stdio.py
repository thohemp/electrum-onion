...
from electrum_onion import WalletStorage, Wallet
from electrum_onion.wallet_db import WalletDB
from electrum_onion.util import format_satoshis
from electrum_onion.bitcoin import is_address, COIN
from electrum_onion.transaction import PartialTxOutput
from electrum_onion.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-onion create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid deeponion address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-onion setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-onion setconfig' to change your settings")
        return True
