...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_onion.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_onion"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_onion:externalType",
                '',
                data)
        return extRecord
