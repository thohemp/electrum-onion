...
from electrum_onion.invoices import pr_tooltips, pr_color
from electrum_onion.invoices import PR_UNKNOWN, PR_UNPAID, PR_FAILED, PR_TYPE_LN
    ...
    AnchorLayout:
        ...
        BoxLayout:
            ...
            BoxLayout:
                ...
                IconButton:
                    icon: 'atlas://electrum_onion/gui/kivy/theming/light/copy'
                    size_hint: 0.5, None
                    height: '48dp'
                    on_release: root.copy_to_clipboard()
                IconButton:
                    icon: 'atlas://electrum_onion/gui/kivy/theming/light/share'
                    size_hint: 0.5, None
                    height: '48dp'
...
class RequestDialog(Factory.Popup):
    ...
    def do_share(self):
        self.app.do_share(self.data, _("Share deeponion Request"))
        self.dismiss()
