...
from electrum_onion.wallet import WalletStorage, Wallet
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            IconButton:
                size_hint: 0.15, None
                height: '40dp'
                icon: 'atlas://electrum_onion/gui/kivy/theming/light/btn_create_account'
        ...
        BoxLayout:
            ...
            IconButton:
                height: '40dp'
                size_hint: 0.15, None
                icon: 'atlas://electrum_onion/gui/kivy/theming/light/eye1'
                icon_size: '40dp'
                on_release:
