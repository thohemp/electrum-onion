...
Label.register('Roboto',
               'electrum_onion/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_onion/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_onion/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_onion/gui/kivy/data/fonts/Roboto-Bold.ttf')
...
class ElectrumWindow(App, Logger):
    ...
    def on_new_intent(self, intent):
        ...
        if str(intent.getScheme()).lower() in ('deeponion', 'lightning'):
    ...
    def _process_invoice_str(self, invoice: str) -> None:
        ...
        if not self.send_screen:
            ...
            self._invoice_intent_queued = invoice
            return
        if invoice.lower().startswith('deeponion:'):
    ...
    def build(self):
        return Builder.load_file('electrum_onion/gui/kivy/main.kv')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_onion/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        self.icon = "electrum_onion/gui/icons/electrum-onion.png"
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
                   exit=False, icon='atlas://electrum_onion/gui/kivy/theming/light/error', duration=0,
                   modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_onion/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_onion/gui/kivy/theming/light/card'
        else:
