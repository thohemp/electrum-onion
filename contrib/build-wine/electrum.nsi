...
;Variables
  ...
  !define PRODUCT_NAME "electrum-onion"
  !define PRODUCT_WEB_SITE "https://github.com/pooler/electrum-onion"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-onion-setup.exe"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum-onion\electrum_onion\gui\icons\electrum.ico"
...
Section
  ...
  File /r "dist\electrum-onion\*.*"
  File "c:\electrum-onion\electrum_onion\gui\icons\electrum.ico"
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-onion-${PRODUCT_VERSION}.exe" ""

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-onion-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-onion-${PRODUCT_VERSION}.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-onion-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-onion-${PRODUCT_VERSION}.exe" 0
